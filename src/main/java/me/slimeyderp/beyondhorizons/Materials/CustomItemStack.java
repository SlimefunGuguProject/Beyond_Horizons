...
public class CustomItemStack {
    ...
    public static final SlimefunItemStack PORTABLE_DIMESNION_SHIFTER_STACK = new SlimefunItemStack("PORTABLE_DIMENSION_SHIFTER", Material.CLOCK, "&ePortable Dimension Shifter", "", "&dShift your location into a twisted dimension", "&4WARNING: This item will transport", "&4you to a different dimension.");
    public static final SlimefunItemStack AETHERIAL_WIND_STAFF_STACK = new SlimefunItemStack("AETHERIAL_WIND_STAFF", Material.STICK, "&eAetherial Wind Staff", "", "&dA stick with a weird stone.", "&dI wonder what would happen if you", "&d used it in a twisted place?");
}
