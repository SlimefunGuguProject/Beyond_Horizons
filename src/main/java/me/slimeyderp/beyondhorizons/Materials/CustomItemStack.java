...
public class CustomItemStack {
    ...
    public static final SlimefunItemStack DIMENSIONAL_REACTOR_STACK = new SlimefunItemStack("DIMENSIONAL_REACTOR", "9343ce58da54c79924a2c9331cfc417fe8ccbbea9be45a7ac85860a6c730", "&1Dimensional Reactor", "", "&rRuns on Raw Aether Ore!", "&8\u21E8 &bMust be surrounded by Water", "&8\u21E8 &bMust be supplied with Super-Charged Reactor Coolant Cells", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.GENERATOR), LoreBuilder.powerBuffer(101004), LoreBuilder.powerPerSecond(3500));
    public static final SlimefunItemStack COAL_DUST_STACK = new SlimefunItemStack("COAL_DUST", Material.GUNPOWDER, "Coal Dust");
    ...
    public static final SlimefunItemStack COAL_DRILL_RECIPETELLER_STACK = new SlimefunItemStack("COAL_DRILL_RECIPETELL", Material.GRAY_TERRACOTTA, "§4Coal Drill", "", "Make this item in a Coal drill");
    public static final SlimefunItemStack DIMENSIONAL_TRANSMUTATOR_RECIPETELLER_STACK = new SlimefunItemStack("DIMENSIONAL_TRANSMUTATOR_RECIPETELLER", Material.RED_STAINED_GLASS, "§dDimensional Transmutator", "", "Make this item in a Dimensional Transmutator");
}
